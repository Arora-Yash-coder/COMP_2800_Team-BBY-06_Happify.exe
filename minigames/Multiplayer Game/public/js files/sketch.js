...
function preload() {
    imgs[0] = loadImage('character/Character_57.png');
    imgs[1] = loadImage('character/Character_81.png');
    imgs[2] = loadImage('character/Character_224.png');
    imgs[3] = loadImage('character/Character_251.png');
}
